...
function encodeDownlink(input) {
  ...
  if (input.data.value == "OFF") {
      value = 0x00;
  } else if (input.data.value == "ON") {
      value = 0x01;
  } else if (input.data.value == "TOGGLE") {
      value = 0x02;
  }
  return {bytes: [0x11, 0x50, 0x00, 0x06, value]};
}
